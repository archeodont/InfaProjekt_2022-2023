...
Opis::Opis()
{
	...
	textOpis[0].setCharacterSize(70);
	textOpis[0].setPosition(Opiswidth - textOpis[0].getLocalBounds().width / 2.f, Opisheight - Ohdiff * 1);

	textOpis[1].setFont(fontOpis);
	textOpis[1].setFillColor(Color::Color(120, 80, 0));
	textOpis[1].setString("Opis");
	textOpis[1].setCharacterSize(40);
	...
	textOpis[2].setString("Opis");
	textOpis[2].setCharacterSize(40);
	...
	textOpis[3].setString("Opis");
	textOpis[3].setCharacterSize(40);
	...
	textOpis[4].setString("Opis");
	textOpis[4].setCharacterSize(40);
	...
	textOpis[5].setString("Opis");
	textOpis[5].setCharacterSize(40);
	textOpis[5].setPosition(Opiswidth - textOpis[5].getLocalBounds().width / 2.f, Opisheight + Ohdiff * 5);

	textOpis[6].setFont(fontOpis);
	textOpis[6].setFillColor(Color::Color(120, 80, 0));
	textOpis[6].setString("Opis");
	textOpis[6].setCharacterSize(40);
	textOpis[6].setPosition(Opiswidth - textOpis[6].getLocalBounds().width / 2.f, Opisheight + Ohdiff * 6);

	textOpis[7].setFont(fontOpis);
	textOpis[7].setFillColor(Color::Color(120, 80, 0));
	textOpis[7].setString("Opis");
	textOpis[7].setCharacterSize(40);
	textOpis[7].setPosition(Opiswidth - textOpis[7].getLocalBounds().width / 2.f, Opisheight + Ohdiff * 7);

	textOpis[8].setFont(fontOpis);
	textOpis[8].setFillColor(Color::Color(120, 80, 0));
	textOpis[8].setString("Opis");
	textOpis[8].setCharacterSize(40);
	...
	textOpis[9].setString("Opis");
	textOpis[9].setCharacterSize(40);
